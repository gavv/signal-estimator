...
void MainWindow::run_estimator() {
    ...
    this->proc->connect(this->proc.data(), SIGNAL(error(QProcess::ProcessError)), this,
        SLOT(checkProc()));
    ...
    this->proc->connect(this->proc.data(), SIGNAL(readyReadStandardOutput()), this,
        SLOT(read_graph_data()));
    // this->proc->connect(this->proc,SIGNAL(finished(int)), this,
